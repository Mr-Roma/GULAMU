...
import 'package:team_10_app/widgets/onboarding_widget/onboarding_indicator.dart';
...
class _IntroScreensState extends State<IntroScreens>
  ...
  // Updated onSkip function
  void onSkip() {
    if (widget.onSkip != null) {
      widget.onSkip!();
    } else {
      _controller!.animateTo(
        widget.slides.length - 1.toDouble(),
        duration: Duration(milliseconds: 400),
        curve: Curves.fastOutSlowIn,
      );
      setState(() {
        currentPage = widget.slides.length - 1; // Update current page index
      });
    }
  }
